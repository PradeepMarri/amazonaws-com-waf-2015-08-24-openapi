...
func DeletesqlinjectionmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteSqlInjectionMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteSqlInjectionMatchSet", cfg.BaseURL)
		...
		var result models.DeleteSqlInjectionMatchSetResponse
...
func CreateDeletesqlinjectionmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteSqlInjectionMatchSet",
		...
		mcp.WithString("SqlInjectionMatchSetId", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletesqlinjectionmatchsetHandler(cfg),
	}
}
