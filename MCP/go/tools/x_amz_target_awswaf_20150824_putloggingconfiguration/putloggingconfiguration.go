...
func PutloggingconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutLoggingConfigurationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.PutLoggingConfiguration", cfg.BaseURL)
		...
		var result models.PutLoggingConfigurationResponse
...
func CreatePutloggingconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_PutLoggingConfiguration",
		...
		mcp.WithString("LoggingConfiguration", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutloggingconfigurationHandler(cfg),
	}
}
