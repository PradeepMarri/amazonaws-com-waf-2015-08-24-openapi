...
func CreateregexmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateRegexMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateRegexMatchSet", cfg.BaseURL)
		...
		var result models.CreateRegexMatchSetResponse
...
func CreateCreateregexmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateRegexMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateregexmatchsetHandler(cfg),
	}
}
