...
func CreategeomatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateGeoMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateGeoMatchSet", cfg.BaseURL)
		...
		var result models.CreateGeoMatchSetResponse
...
func CreateCreategeomatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateGeoMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreategeomatchsetHandler(cfg),
	}
}
