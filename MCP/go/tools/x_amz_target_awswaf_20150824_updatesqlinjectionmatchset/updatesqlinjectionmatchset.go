...
func UpdatesqlinjectionmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateSqlInjectionMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateSqlInjectionMatchSet", cfg.BaseURL)
		...
		var result models.UpdateSqlInjectionMatchSetResponse
...
func CreateUpdatesqlinjectionmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateSqlInjectionMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatesqlinjectionmatchsetHandler(cfg),
	}
}
