...
func UpdateratebasedruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRateBasedRuleRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateRateBasedRule", cfg.BaseURL)
		...
		var result models.UpdateRateBasedRuleResponse
...
func CreateUpdateratebasedruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateRateBasedRule",
		...
		mcp.WithString("RateLimit", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateratebasedruleHandler(cfg),
	}
}
