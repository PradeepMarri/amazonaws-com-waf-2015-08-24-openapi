...
func UpdaterulegroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRuleGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateRuleGroup", cfg.BaseURL)
		...
		var result models.UpdateRuleGroupResponse
...
func CreateUpdaterulegroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateRuleGroup",
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdaterulegroupHandler(cfg),
	}
}
