...
func CreatesqlinjectionmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateSqlInjectionMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateSqlInjectionMatchSet", cfg.BaseURL)
		...
		var result models.CreateSqlInjectionMatchSetResponse
...
func CreateCreatesqlinjectionmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateSqlInjectionMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatesqlinjectionmatchsetHandler(cfg),
	}
}
