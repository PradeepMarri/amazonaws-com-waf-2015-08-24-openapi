...
func DeletebytematchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteByteMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteByteMatchSet", cfg.BaseURL)
		...
		var result models.DeleteByteMatchSetResponse
...
func CreateDeletebytematchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteByteMatchSet",
		...
		mcp.WithString("ByteMatchSetId", mcp.Required(), mcp.Description("")),
		mcp.WithString("ChangeToken", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletebytematchsetHandler(cfg),
	}
}
