...
func DeletexssmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteXssMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteXssMatchSet", cfg.BaseURL)
		...
		var result models.DeleteXssMatchSetResponse
...
func CreateDeletexssmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteXssMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletexssmatchsetHandler(cfg),
	}
}
