...
func UpdateregexpatternsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRegexPatternSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateRegexPatternSet", cfg.BaseURL)
		...
		var result models.UpdateRegexPatternSetResponse
...
func CreateUpdateregexpatternsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateRegexPatternSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateregexpatternsetHandler(cfg),
	}
}
