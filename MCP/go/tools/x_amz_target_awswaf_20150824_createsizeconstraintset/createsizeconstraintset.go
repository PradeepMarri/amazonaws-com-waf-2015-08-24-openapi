...
func CreatesizeconstraintsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateSizeConstraintSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateSizeConstraintSet", cfg.BaseURL)
		...
		var result models.CreateSizeConstraintSetResponse
...
func CreateCreatesizeconstraintsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateSizeConstraintSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatesizeconstraintsetHandler(cfg),
	}
}
