...
func CreatebytematchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateByteMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateByteMatchSet", cfg.BaseURL)
		...
		var result models.CreateByteMatchSetResponse
...
func CreateCreatebytematchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateByteMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatebytematchsetHandler(cfg),
	}
}
