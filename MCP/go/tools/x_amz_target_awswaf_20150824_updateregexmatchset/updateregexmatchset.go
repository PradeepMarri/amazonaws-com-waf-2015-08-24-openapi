...
func UpdateregexmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRegexMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateRegexMatchSet", cfg.BaseURL)
		...
		var result models.UpdateRegexMatchSetResponse
...
func CreateUpdateregexmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateRegexMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateregexmatchsetHandler(cfg),
	}
}
