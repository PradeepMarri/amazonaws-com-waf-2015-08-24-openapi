...
func GetsampledrequestsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetSampledRequestsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.GetSampledRequests", cfg.BaseURL)
		...
		var result models.GetSampledRequestsResponse
...
func CreateGetsampledrequestsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_GetSampledRequests",
		...
		mcp.WithString("RuleId", mcp.Required(), mcp.Description("")),
		mcp.WithString("TimeWindow", mcp.Required(), mcp.Description("")),
		mcp.WithString("WebAclId", mcp.Required(), mcp.Description("")),
		mcp.WithString("MaxItems", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetsampledrequestsHandler(cfg),
	}
}
