...
func GetchangetokenstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetChangeTokenStatusRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.GetChangeTokenStatus", cfg.BaseURL)
		...
		var result models.GetChangeTokenStatusResponse
...
func CreateGetchangetokenstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_GetChangeTokenStatus",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetchangetokenstatusHandler(cfg),
	}
}
