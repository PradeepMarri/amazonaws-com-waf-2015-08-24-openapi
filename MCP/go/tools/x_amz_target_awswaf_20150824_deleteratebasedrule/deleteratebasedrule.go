...
func DeleteratebasedruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteRateBasedRuleRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteRateBasedRule", cfg.BaseURL)
		...
		var result models.DeleteRateBasedRuleResponse
...
func CreateDeleteratebasedruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteRateBasedRule",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteratebasedruleHandler(cfg),
	}
}
