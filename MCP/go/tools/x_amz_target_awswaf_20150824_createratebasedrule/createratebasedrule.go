...
func CreateratebasedruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateRateBasedRuleRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateRateBasedRule", cfg.BaseURL)
		...
		var result models.CreateRateBasedRuleResponse
...
func CreateCreateratebasedruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateRateBasedRule",
		...
		mcp.WithString("RateKey", mcp.Required(), mcp.Description("")),
		mcp.WithString("RateLimit", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateratebasedruleHandler(cfg),
	}
}
