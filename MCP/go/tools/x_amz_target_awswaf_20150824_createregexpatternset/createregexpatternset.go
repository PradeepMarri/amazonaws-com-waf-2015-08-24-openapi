...
func CreateregexpatternsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateRegexPatternSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateRegexPatternSet", cfg.BaseURL)
		...
		var result models.CreateRegexPatternSetResponse
...
func CreateCreateregexpatternsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateRegexPatternSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateregexpatternsetHandler(cfg),
	}
}
