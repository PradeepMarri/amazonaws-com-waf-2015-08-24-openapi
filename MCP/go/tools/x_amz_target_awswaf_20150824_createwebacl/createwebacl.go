...
func CreatewebaclHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateWebACLRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateWebACL", cfg.BaseURL)
		...
		var result models.CreateWebACLResponse
...
func CreateCreatewebaclTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateWebACL",
		...
		mcp.WithString("DefaultAction", mcp.Required(), mcp.Description("")),
		mcp.WithString("MetricName", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreatewebaclHandler(cfg),
	}
}
