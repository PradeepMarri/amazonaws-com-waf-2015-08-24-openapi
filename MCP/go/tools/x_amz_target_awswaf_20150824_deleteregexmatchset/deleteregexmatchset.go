...
func DeleteregexmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteRegexMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteRegexMatchSet", cfg.BaseURL)
		...
		var result models.DeleteRegexMatchSetResponse
...
func CreateDeleteregexmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteRegexMatchSet",
		...
		mcp.WithString("RegexMatchSetId", mcp.Required(), mcp.Description("")),
		mcp.WithString("ChangeToken", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeleteregexmatchsetHandler(cfg),
	}
}
