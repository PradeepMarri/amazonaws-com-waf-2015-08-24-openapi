...
func DeletewebaclHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteWebACLRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteWebACL", cfg.BaseURL)
		...
		var result models.DeleteWebACLResponse
...
func CreateDeletewebaclTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteWebACL",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletewebaclHandler(cfg),
	}
}
