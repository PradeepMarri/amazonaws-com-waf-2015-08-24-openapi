...
func PutpermissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutPermissionPolicyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.PutPermissionPolicy", cfg.BaseURL)
		...
		var result models.PutPermissionPolicyResponse
...
func CreatePutpermissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_PutPermissionPolicy",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PutpermissionpolicyHandler(cfg),
	}
}
