...
func CreateipsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateIPSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateIPSet", cfg.BaseURL)
		...
		var result models.CreateIPSetResponse
...
func CreateCreateipsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateIPSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateipsetHandler(cfg),
	}
}
