...
func UpdatewebaclHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateWebACLRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.UpdateWebACL", cfg.BaseURL)
		...
		var result models.UpdateWebACLResponse
...
func CreateUpdatewebaclTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_UpdateWebACL",
		...
		mcp.WithString("DefaultAction", mcp.Description("")),
		mcp.WithString("Updates", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatewebaclHandler(cfg),
	}
}
