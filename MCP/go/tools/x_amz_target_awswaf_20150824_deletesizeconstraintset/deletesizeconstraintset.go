...
func DeletesizeconstraintsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteSizeConstraintSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.DeleteSizeConstraintSet", cfg.BaseURL)
		...
		var result models.DeleteSizeConstraintSetResponse
...
func CreateDeletesizeconstraintsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_DeleteSizeConstraintSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletesizeconstraintsetHandler(cfg),
	}
}
