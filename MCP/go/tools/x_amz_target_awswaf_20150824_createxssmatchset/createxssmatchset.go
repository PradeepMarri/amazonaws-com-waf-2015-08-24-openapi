...
func CreatexssmatchsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateXssMatchSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSWAF_20150824.CreateXssMatchSet", cfg.BaseURL)
		...
		var result models.CreateXssMatchSetResponse
...
func CreateCreatexssmatchsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AWSWAF_20150824_CreateXssMatchSet",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatexssmatchsetHandler(cfg),
	}
}
